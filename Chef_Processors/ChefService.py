...
class ChefService(Processor):
  ...
  input_variables = {
    ...
    "service_reload_command": {
      "required": False,
      "description": ("The command used to tell a service to "
    ...
    "service_retries": {
      "required": False,
      "description": ("The number of times to catch exceptions "
                      "and retry the resource.")
    },
    "service_retry_delay": {
      "required": False,
    ...
    "service_subscribes": {
      "required": False,
      "description": ("Specify that this resource is to listen "
                      "to another resource, and then take action "
                      "when that resource's state changes.")
    },
    "service_supports": {
      "required": True,
      "description": ("A list of properties that controls how the "
