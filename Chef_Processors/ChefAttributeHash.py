...
class ChefAttributeHash(Processor):
  description = ("Produces a Chef attribute variable for a hash of items. "
  ...
  input_variables = {
    ...
    "value": {
      "required": True,
      "description": ("Dictionary of keys and values.")
    },
    "in_array": {
      "required": False,
      "description": ("Is this hash inside an array? If yes, a comma is "
                      "added to the end"),
    }
  }
  output_variables = {
    "chef_block": {
      "description": "Chef attribute block."
    },
    "attribute_variable": {
