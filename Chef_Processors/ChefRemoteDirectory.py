...
class ChefRemoteDirectory(Processor):
  description = ("Produces a remote_directory Chef block. See "
  ...
  input_variables = {
    ...
    "files_backup": {
      "required": False,
      "description": ("The number of backup copies to keep for files in the "
                      "directory.")
    },
    "files_group": {
      "required": False,
      "description": ("Configure group permissions for files. A string or ID "
    ...
    "files_owner": {
      "required": False,
      "description": ("Configure owner permissions for files. A string or ID "
                      "that identifies the group owner by group name.")
    },
    "group": {
      "required": False,
